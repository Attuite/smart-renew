param(
  [int]$Port = 4173,
  [string]$SecretScriptPath = 'D:\xwechat_files\wxid_nx491mkybq3l22_6563\msg\file\2026-08\image_test.py'
)
...
Write-Host "Smart Renew LAN proxy: http://$lanAddress`:$Port"
...
try {
  ...
  Pop-Location
  Remove-Item Env:\GROUP_VISION_API_KEY -ErrorAction SilentlyContinue
}
